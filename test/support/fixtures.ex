  ...
  def generate_orgs() do
    [
      {"fiqus",
       struct(
         Organization,
         Coophub.map_string_to_atom_keys(%{
    ...
    [
      struct(
        ...
        Coophub.map_string_to_atom_keys(%{
          ...
          "issue_events_url" =>
            "https://api.github.com/repos/fiqus/surgex/issues/events{/number}",
      ...
      struct(
        ...
        Coophub.map_string_to_atom_keys(%{
          ...
          "issue_events_url" =>
            "https://api.github.com/repos/fiqus/uk-talk/issues/events{/number}",
